      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h1
                className={`font-bold transition-all duration-300 truncate ${
                  scrolled ? 'text-base md:text-lg' : 'text-lg md:text-xl lg:text-2xl'
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <ShareComponent type="store" item={store} mallId={mall.id} />
            ...
            {!scrolled && (
              <Button3D variant="primary" className="hidden md:flex px-4 py-2 text-sm">
                {t('buttons.follow')}
              </Button3D>
            )}
          </div>
