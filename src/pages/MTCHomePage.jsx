...
export default function MTCHomePage() {
  ...
  useEffect(() => {
    // Load malls with staggered animation
    ...
    <div className="min-h-screen pb-24 md:pb-0">
      ...
      <section className="mtc-container mtc-section">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="mtc-button-secondary hidden md:flex items-center gap-2">
            View All
              ...
              <div key={promo.id} className="w-full flex-shrink-0">
                <div className="relative aspect-[21/9] md:aspect-[16/5] overflow-hidden rounded-3xl mtc-card group">
                  ...
                  <div className="absolute inset-0 p-6 md:p-10 flex flex-col justify-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/20 backdrop-blur-md border border-blue-400/30 w-fit mb-4">
          ...
          {events.map((event) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mtc-caption text-white/50">{event.mall}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/10 to-purple-500/10">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="mtc-body text-white/70 mb-6">Interactive map with all locations, routes, and directions</p>
                <button
                  className="mtc-button-primary"
                  onClick={() => window.location.href = '/map'}
                >
                  Open Full Map
                  <ChevronRight size={18} />
        ...
        <div className="rounded-3xl overflow-hidden mtc-glass p-8 md:p-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              ...
              />
              <button className="mtc-button-primary whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
